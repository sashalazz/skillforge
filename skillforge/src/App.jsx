...
function buildEvalPrompt(sc, convo) {
  ...
  return `Coach di soft skills. Valuta questo roleplay.
Scenario: ${sc.brief} | Ruolo utente: ${sc.role_user} | Criteri: ${sc.evaluation_criteria.join(", ")}
Conversazione:
${txt}
Rispondi SOLO JSON:
{"overall_score":<1-10>,"summary":"<2 frasi>","scores":[{"criterion":"<nome>","score":<1-10>,"comment":"<feedback breve>"}],"strengths":["<1>","<2>"],"improvements":["<1>","<2>"],"key_moment":"<momento chiave>","academy_tip":"<consiglio>"}`;
}
...
export default function App() {
  ...
  const generateReport = useCallback(async () => {
    ...
    const raw = await callAI([{ role: "user", content: prompt }], "Coach esperto. Rispondi SOLO JSON valido.", 600);
    try {
      setReport(JSON.parse(raw.replace(/```json|```/g, "").trim()));
    } catch {
      setReport({
        overall_score: 7, summary: "Buona performance con margini di miglioramento.",
        scores: selectedScenario.evaluation_criteria.map(c => ({ criterion: c, score: 7, comment: "Valutazione generata." })),
        strengths: ["Buona comunicazione", "Impegno nel dialogo"], improvements: ["Più specificità", "Più struttura"],
        key_moment: "La conversazione ha mostrato impegno.", academy_tip: "Pratica regolarmente con scenari diversi."
      });
    }
          ...
          {isGeneratingReport || !report ? (
            ...
            <>
              ...
              <div style={{ ...S.glass, textAlign: "center", marginBottom: "20px", padding: "32px" }}>
                ...
                <div style={{ fontSize: "13px", color: "rgba(255,255,255,0.3)", marginTop: "12px", letterSpacing: "2px", textTransform: "uppercase" }}>Punteggio</div>
                <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.6)", lineHeight: 1.7, marginTop: "12px", maxWidth: "500px", margin: "12px auto 0" }}>{report.summary}</p>
              </div>

              <div style={{ ...S.glass, marginBottom: "20px" }}>
                <div style={{ fontSize: "11px", letterSpacing: "3px", textTransform: "uppercase", color: "rgba(255,255,255,0.3)", marginBottom: "20px" }}>Criteri</div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "20px" }}>
                <div style={{ background: "rgba(0,184,148,0.08)", borderRadius: "16px", padding: "20px", border: "1px solid rgba(0,184,148,0.15)" }}>
                  <div style={{ fontSize: "11px", letterSpacing: "3px", textTransform: "uppercase", color: "#00B894", marginBottom: "14px" }}>✓ Forza</div>
                  {report.strengths.map((s, i) => (
                    <div key={i} style={{ fontSize: "13px", color: "rgba(255,255,255,0.6)", lineHeight: 1.6, marginBottom: "8px", paddingLeft: "12px", borderLeft: "2px solid rgba(0,184,148,0.3)" }}>{s}</div>
                  ))}
                </div>
                <div style={{ background: "rgba(232,101,90,0.08)", borderRadius: "16px", padding: "20px", border: "1px solid rgba(232,101,90,0.15)" }}>
                  <div style={{ fontSize: "11px", letterSpacing: "3px", textTransform: "uppercase", color: "#E8655A", marginBottom: "14px" }}>↑ Migliorare</div>
              ...
              <div style={{ background: "rgba(108,92,231,0.08)", borderRadius: "16px", padding: "20px", border: "1px solid rgba(108,92,231,0.15)", marginBottom: "20px" }}>
                <div style={{ fontSize: "11px", letterSpacing: "3px", textTransform: "uppercase", color: "#6C5CE7", marginBottom: "8px" }}>⚡ Momento Chiave</div>
              ...
              <div style={{ background: "linear-gradient(135deg, rgba(108,92,231,0.12), rgba(232,101,90,0.12))", borderRadius: "16px", padding: "20px", border: "1px solid rgba(255,255,255,0.08)", marginBottom: "28px" }}>
                <div style={{ fontSize: "11px", letterSpacing: "3px", textTransform: "uppercase", color: "rgba(255,255,255,0.4)", marginBottom: "8px" }}>🎓 Consiglio</div>
